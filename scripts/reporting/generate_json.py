...
def main() -> int:
    ...
    report = {
        ...
        "application_security": {
            ...
            "remediation_roadmap": {
                "immediate": [f.get("id") for f in findings if f.get("priority") == "P0"],
                "short_term": [f.get("id") for f in findings if f.get("priority") == "P1"],
                "medium_term": [f.get("id") for f in findings if f.get("priority") in ("P2", "P3")],
                "hardening": [f.get("id") for f in findings if f.get("priority") == "P4"],
            },
        },
