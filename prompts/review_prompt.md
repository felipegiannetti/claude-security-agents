...
Condensed task prompt corresponding to [agents/security-reviewer.md](../agents/security-reviewer.md) — used by `06_llm_security_review` and re-invoked narrowly by `07_data_flow_analysis` when a specific candidate finding needs a deeper source-to-sink trace.

---

Include [system_prompt.md](system_prompt.md).

## Full review task (06_llm_security_review)
...
## Data-flow deep-dive task (07_data_flow_analysis)
